...
try:
    ...
    #калибровка моторчика (узнаем, сколько шагов совершает моторчик при передвижении на 51мм)
    s = str(51) + "mm" + "\n" + str(abs(steps)) + "steps" 
    with open("/home/gr106/Desktop/Scripts/calibration.txt", "w") as outfile:
       outfile.write(s)  
